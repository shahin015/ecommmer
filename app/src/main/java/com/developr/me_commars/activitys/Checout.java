...
import com.developr.me_commars.databinding.ActivityChecoutBinding;
...
public class Checout extends AppCompatActivity {
    ActivityChecoutBinding binding;


   Cartadapeter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityChecoutBinding.inflate(getLayoutInflater());
        ...
        for(Map.Entry<Item, Integer> item : cart.getAllItemsWithQty().entrySet()) {
           ...
           // product.setQuantity(quantity);
            product.setQuanty(quantity);

            products.add(product);
        }

        adapter = new Cartadapeter(this, products, new Cartadapeter.Cartlesenaer() {
            @Override
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.getString("status").equals("success")) {
                        Toast.makeText(Checout.this, "Success order.", Toast.LENGTH_SHORT).show();
                        String orderNumber = response.getJSONObject("data").getString("code");
                        new AlertDialog.Builder(Checout.this)
                                ...
                                .setPositiveButton("Pay Now", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent intent = new Intent(Checout.this, PaymentActivity.class);
                        ...
                        Toast.makeText(Checout.this, "Failed order.", Toast.LENGTH_SHORT).show();
                    }
